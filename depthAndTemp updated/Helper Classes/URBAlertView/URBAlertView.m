...
//KALPESH changed due to square pop up and change dimention
...
- (void)initialize {
//	_backgroundColor = [UIColor colorWithWhite:0.22 alpha:1.0];//KALPESH
    _backgroundColor = [UIColor whiteColor];

	_backgroundGradation = 0.1;
//	_strokeColor = [UIColor colorWithWhite:0.8 alpha:1.000];//KALPESH
    _strokeColor = [UIColor whiteColor];

//	_strokeWidth = 3.0;
//	_cornerRadius = 6.0;//KALPESH
    
    _strokeWidth = 0.0;//KALPESH
    _cornerRadius = 0.0;//KALPESH
	
	_titleFont = [UIFont boldSystemFontOfSize:15.0];
//	_titleColor = [UIColor whiteColor];//KALPESH
    _titleColor = [UIColor darkGrayColor];//KALPESH
//    _titleColor = [UIColor blackColor];
//    _titleColor = [APP_DELEGATE colorWithHexString:yellow_color];
//    _titleColor = [UIColor clearColor];


//	_titleShadowColor = [UIColor blackColor];//KALPESH
    _titleShadowColor = [UIColor clearColor];

	_titleShadowOffset = CGSizeMake(0.0, -1.0);
	
	_messageFont = [UIFont systemFontOfSize:14.0];
//	_messageColor = [UIColor whiteColor];//KALPESH
//    _messageColor = [UIColor darkGrayColor];//KALPESH
    _messageColor = [UIColor blackColor];


//	_messageShadowColor = [UIColor blackColor];//KALPESH
    _messageShadowColor = [UIColor clearColor];

	_messageShadowOffset = CGSizeMake(0.0, -1.0);
	
//	_buttonBackgroundColor = [UIColor colorWithWhite:0.35 alpha:1.0];//KALPESH
//    _buttonBackgroundColor = [UIColor blueColor];
//    _buttonBackgroundColor = [APP_DELEGATE colorWithHexString:yellow_color];//KALPESH
...
//	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(deviceOrientationChanged:) name:UIDeviceOrientationDidChangeNotification object:nil];//KALPESH
	
	// register for keyboard notifications
//	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(keyboardWillShow:) name:UIKeyboardWillShowNotification object:nil];//KALPESH
//	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(keyboardWillHide:) name:UIKeyboardWillHideNotification object:nil];//KALPESH
...
//	button.titleLabel.font = [UIFont boldSystemFontOfSize:16.0];//KALPESH
    button.titleLabel.font = [UIFont boldSystemFontOfSize:18.0];
//    button.titleLabel.font = [UIFont fontWithName:SinkinSansBoldFont size:16];//KALPESH change button text color
...
//            self.transform = translate;//KALPESH
...
//                self.transform = translate;//KALPESH
    ...
    else if (animation == URBAlertAnimationTopToBottom)//KALPESH
    {
        if (show)
        {
            [self showOverlay:YES];
...
//            CGAffineTransform rotate = CGAffineTransformRotate(transform, 50.0 * M_PI / 180.0);//KALPESH
//            CGAffineTransform translate = CGAffineTransformTranslate(transform, 00.0, -screenSize.height / 2.0 - CGRectGetWidth(self.bounds));//top to bottom
            CGAffineTransform translate1 = CGAffineTransformMakeTranslation(0, 568);//KALPESH bottom to top

//            self.transform = translate;
            self.transform = translate1;//KALPESH
...
//    [self.contentView addSubview:beloved]; //temp 16-4 //KALPESH
...
//	CGContextSetLineWidth(context, 1.0f);//KALPESH
    CGContextSetLineWidth(context, 0.0f);//KALPESH 17-4
...
//	keylinePath.lineWidth = 1.0;//KALPESH remove seperator line
    keylinePath.lineWidth = 0.0;
//    keylinePath.lineWidth = 0.5;

	
//	CGContextTranslateCTM(context, 0, CGRectGetMinY(hatchFrame) - 2.0);//KALPESH
    CGContextTranslateCTM(context, 0, CGRectGetMinY(hatchFrame) + 7.0);

	[self.darkKeylineColor setStroke];
	[keylinePath stroke];
//	CGContextTranslateCTM(context, 0, 1.0);//KALPESH
...
//	UIColor *gradientInner = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.1];
    ...
    UIColor *gradientInner = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 0.5];//KALPESH for removing round background shadow
...
//		_strokeColor = [UIColor colorWithWhite:0.2 alpha:1.0];//KALPESH
        _strokeColor = [UIColor whiteColor];
...
//    UIColor *buttonInnerGradientColor2 = [UIColor colorWithRed:255.0/255 green:213.0/255 blue:132.0/255 alpha:1];
    ...
    UIColor *buttonInnerGradientColor2 = [UIColor clearColor];//KALPESH
...
//								0);
//	CGContextRestoreGState(context);//KALPESH
	
	// outer drawing
//	CGRect buttonOuterRect = CGRectInset(frame, 4.0, 4.0);
    CGRect buttonOuterRect = CGRectInset(frame, 0.0, 0.0);//KALPESH
	...
	// inner drawing
//	CGRect buttonInnerRect = CGRectInset(frame, 6.0, 6.0);//KALPESH
...
//	UIColor *buttonInnerGradientColor2 = [self.backgroundColor adjustBrightness:1.05];
    ...
    UIColor *buttonInnerGradientColor2 = [UIColor lightGrayColor];//KALPESH
    
//    UIColor *buttonInnerGradientColor = [APP_DELEGATE colorWithHexString:@"d3d3d3"];//light gray color
//    UIColor *buttonInnerGradientColor2 = [APP_DELEGATE colorWithHexString:@"d3d3d3"];//KALPESH
