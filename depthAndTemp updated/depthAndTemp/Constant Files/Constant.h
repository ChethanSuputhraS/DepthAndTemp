...
#define global_color  [UIColor colorWithRed:41.0/255.0f green:128.0/255.0f blue:185.0/255.0f alpha:1.0]
...
#define ALERT_TITLE @"Succorfish Depth N Temp App"
...
#define Dive1_Color [UIColor colorWithRed:255/255.f green:102/255.f blue:0.f alpha:1.f]
#define Dive2_Color [UIColor colorWithRed:125.0/255.f green:162.0/255.f blue:117.f/255.0 alpha:1.f]
